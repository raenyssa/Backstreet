...
/// <summary>
/// Represents the different states that the shoplifting NPC can be in.
/// </summary>
...
/// <summary>
/// Controls the behaviour of the shoplifting NPC, including patrolling,
/// fleeing from the player, and being caught.
/// </summary>
public class ShopliftNPC : MonoBehaviour
{
    /// <summary>
    /// Stores the current state of the shoplifting NPC.
    /// </summary>
    ...
    /// <summary>
    /// Audio source used when the player successfully catches the NPC.
    /// </summary>
    ...
    void Update()
    {
        // Run the state machine to determine the NPC's current behaviour.
        StateMachine();
    }
    ...
    /// and updates the player's score and UI.
    /// </summary>
    ...
    /// <summary>
    /// Waits for the specified delay before opening the win panel and playing the win audio.
    /// </summary>
    /// <param name="delay">The amount of time to wait before opening the win panel.</param>
    private IEnumerator OpenWinPanelAfterDelay(float delay)
    {
        // Wait for the specified amount of time.
        yield return new WaitForSeconds(delay);

        // Open the win panel through the UI manager.
        GameManager.instance.uiManager.OpenWinPanel();

        // Play the win audio if an AudioSource has been assigned.
        if (WinAudio != null)
        {
            WinAudio.Play();
        }        
